...
const EMAMA = ({ indicator, setIndicator }) => {
    const handleOperatorChange = (e) => {
        let selectedOperator = e.target.value
        setIndicator({
            ...indicator,
            operator: { type: selectedOperator },
            lowerBound: selectedOperator === 'Above' || selectedOperator === 'Cross above' || selectedOperator === 'Between' ? 0 : null,
            upperBound: selectedOperator === 'Below' || selectedOperator === 'Cross below' || selectedOperator === 'Between' ? 0 : null
        })
    }
